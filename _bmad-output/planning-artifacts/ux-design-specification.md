...
- 如何返回到简洁视图？ - 点击返回按钮或使用快捷键（Escape 或 Ctrl/Cmd + ←）
...
graph TD
    ...
    style AJ fill:#6B7280,stroke:#4B5563,color:#FFFFFF
    style AK fill:#F9FAFB,stroke:#E5E7EB,color:#111827
```
...
graph TD
    ...
    style AZ fill:#6B7280,stroke:#4B5563,color:#FFFFFF
    style BA fill:#F9FAFB,stroke:#E5E7EB,color:#111827
...
graph TD
    ...
    style AN fill:#10B981,stroke:#059669,color:#FFFFFF
    style AO fill:#6B7280,stroke:#4B5563,color:#FFFFFF
    style AP fill:#F9FAFB,stroke:#E5E7EB,color:#111827
```
...
**返回按钮导航：**
- 位置：应用标题栏左侧（仪表板视图、专业视图）
- 图标：← 箭头图标
- 文字：返回简洁视图
- 目标：返回到简洁视图
- 样式：文字按钮，悬停时显示背景色
- 可访问性：`aria-label="返回到简洁视图"`
